...
export default async function BudgetOverviewPage() {
  ...
  // single monthly figure per account. The /budget/[id] page does this same
  // calculation; we mirror it so totals match exactly.
        ...
        <div className="flex flex-wrap items-baseline justify-between gap-3">
          <div>
            ...
            <p className="mt-1 text-sm text-neutral-500">
              {accounts.length} {accounts.length === 1 ? 'konto' : 'konti'} · samlet{' '}
